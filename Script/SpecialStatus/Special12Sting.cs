...
public class Special12Sting : MonoBehaviour, ISpecialStatusFormatDescription, ISpecialStatusEventStart, ISpecialStatusEventEveryTurn
{
	int EveryTurnDamage;
	...
	public IEnumerator StartEffect()
	{
		...
		EveryTurnDamage = (int)(DataComponent.UserBattleStatus.MaxHP * 0.05f);
		yield break;
	}
